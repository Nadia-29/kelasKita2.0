...
<head>
    ...
    <title>Admin Login - KelasKita 2.0</title>
    ...
    <div class="min-h-screen flex">
            ...
            <div class="relative z-10 text-center max-w-lg">
                <div class="mb-8">
                    ...
                    <p class="text-lg text-slate-300 leading-relaxed font-light">
                        Transform your educational management experience. Streamline operations, empower mentors, and
                        inspire students with our comprehensive admin suite.
                    </p>
                </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 bg-white relative">
            <div class="w-full max-w-[400px]">
                ...
                <form action="{{ route('admin.auth.submit') }}" method="POST" class="space-y-6">
                    @csrf
